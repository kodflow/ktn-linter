// ════════════════════════════════════════════════════════════════════════════
// KTN-INTERFACE-005: Interface définie hors de interfaces.go
// ════════════════════════════════════════════════════════════════════════════
...
//
// ❌ CAS INCORRECT 1: Interface hors interfaces.go (SEULE ERREUR: KTN-INTERFACE-005)
// NOTE: PaymentProcessorI005 devrait être dans interfaces.go
// ERREUR ATTENDUE: KTN-INTERFACE-005 sur PaymentProcessorI005
//
// ❌ CAS INCORRECT 2: Interface hors interfaces.go (SEULE ERREUR: KTN-INTERFACE-005)
// NOTE: EmailSenderI005 devrait être dans interfaces.go
// ERREUR ATTENDUE: KTN-INTERFACE-005 sur EmailSenderI005
//
