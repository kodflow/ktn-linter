...
// Bad: Variables with incorrect type visibility (violates KTN-VAR-002)
...
var (
	...
	redundantSlice []string = []string{"a", "b"} // want "KTN-VAR-002: la variable 'redundantSlice' a un type redondant"

	// redundantMap has redundant type
	redundantMap map[string]int = map[string]int{"x": 1} // want "KTN-VAR-002: la variable 'redundantMap' a un type redondant"

	// redundantMake has redundant type
	redundantMake []byte = make([]byte, 0, CAP_VALUE) // want "KTN-VAR-002: la variable 'redundantMake' a un type redondant"

	// redundantConv has redundant type
	redundantConv int = int(MAGIC_VALUE) // want "KTN-VAR-002: la variable 'redundantConv' a un type redondant"
)
