...
// Analyzer015 détecte les conversions string() répétées.
//
...
var Analyzer015 *analysis.Analyzer = &analysis.Analyzer{
	Name:     "ktnvar015",
	Doc:      "KTN-VAR-015: Vérifie les conversions string() répétées",
	Run:      runVar015,
	Requires: []*analysis.Analyzer{inspect.Analyzer},
}

// runVar015 exécute l'analyse de détection des conversions répétées.
//
// Params:
