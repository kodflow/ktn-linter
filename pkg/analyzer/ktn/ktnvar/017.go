...
// Analyzer017 checks for make([]T, N) with small constant N
var Analyzer017 = &analysis.Analyzer{
	Name:     "ktnvar017",
	Doc:      "KTN-VAR-017: Vérifie l'utilisation de [N]T au lieu de make([]T, N)",
	Run:      runVar017,
...
func reportArraySuggestion(pass *analysis.Pass, call *ast.CallExpr) {
	pass.Reportf(
		call.Pos(),
		"KTN-VAR-017: préférer [N]T (array) au lieu de make([]T, N)",
	)
}
