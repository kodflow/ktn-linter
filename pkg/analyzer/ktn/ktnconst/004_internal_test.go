...
// Test_runConst004 tests the runConst004 function.
func Test_runConst004(t *testing.T) {
	tests := []struct {
		name      string
		fn        func(*testing.T)
		expectErr bool
	}{
		{"disabled", Test_runConst004_disabled, false},
		{"excludedFile", Test_runConst004_excludedFile, false},
		{"nonConstDecl", Test_runConst004_nonConstDecl, false},
	}
