...
func SixParams(a, b, c, d, e, f int) {
}

// Bad: Function with 7 parameters of different types
func SevenParams(a int, b string, c bool, d float64, e []int, f map[string]int, g chan int) {
}

// Bad: Function with many parameters
func TooManyParams(a, b, c, d, e, f, g, h, i, j int) {
}

// Bad: Function literal with too many params
var BadLiteral = func(a, b, c, d, e, f int) {
}
...
func EightParams(a int, b, c string, d, e, f bool, g, h float64) {
}

// Bad: Function with exactly 6 parameters (just over limit)
func ExactlySixParams(a, b, c, d, e, f int) {
}

// Bad: Function with variadic parameter but still over limit (6 params)
func WithVariadicBad(a, b, c, d, e int, f ...string) {
}
