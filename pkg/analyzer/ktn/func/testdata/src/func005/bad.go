...
func ComplexityEleven(x int) { // want "KTN-FUNC-005: cyclomatic complexity .* exceeds maximum allowed .*"
...
func VeryComplex(x int) int { // want "KTN-FUNC-005: cyclomatic complexity .* exceeds maximum allowed .*"
...
func ManyLogicalOps(a, b, c, d bool) bool { // want "KTN-FUNC-005: cyclomatic complexity .* exceeds maximum allowed .*"
...
func ComplexSelectRange(ch chan int, items []int) int { // want "KTN-FUNC-005: cyclomatic complexity .* exceeds maximum allowed .*"
	result := 0
...
func SwitchManyWithDefault(x int) int { // want "KTN-FUNC-005: cyclomatic complexity .* exceeds maximum allowed .*"
	result := 0
...
func SelectManyWithDefault(ch1, ch2, ch3, ch4, ch5 chan int) int { // want "KTN-FUNC-005: cyclomatic complexity .* exceeds maximum allowed .*"
	result := 0
