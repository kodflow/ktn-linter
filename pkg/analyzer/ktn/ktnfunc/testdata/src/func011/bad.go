...
// badProcessSixItems creates a slice with magic number 6 (violates KTN-FUNC-011).
...
// badValidateAge checks age validity using magic numbers 18 and 120 (violates KTN-FUNC-011).
//
// Params:
...
// badCalculateDiscount applies discount using magic number 0.15 (violates KTN-FUNC-011).
//
// Params:
...
// badProcessRetries sets max retries using magic number 3 (violates KTN-FUNC-011).
...
// badSetBufferSize creates a buffer using magic number 1024 (violates KTN-FUNC-011).
...
// badCheckThreshold verifies value against magic number 100 (violates KTN-FUNC-011).
//
// Params:
...
// badWaitTimeout sets a timeout using magic number 30 (violates KTN-FUNC-011).
func badWaitTimeout() {
...
// badSetPort assigns a port using magic number 8080 (violates KTN-FUNC-011).
func badSetPort() {
