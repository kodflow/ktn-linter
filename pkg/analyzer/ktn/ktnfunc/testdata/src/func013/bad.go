...
// ComplexityEleven demonstrates a function with cyclomatic complexity = 11 (exceeds limit of 10). This function intentionally violates KTN-FUNC-013 to test the complexity analyzer.
//
// Params:
...
// VeryComplex is a very complex function with nested conditions and multiple paths. This function intentionally violates KTN-FUNC-013 to test high complexity detection.
//
// Params:
...
// ManyLogicalOps contains many logical operators increasing complexity. This function intentionally violates KTN-FUNC-013 through multiple conditions.
//
// Params:
...
// ComplexSelectRange demonstrates high complexity with select and range operations. This function intentionally violates KTN-FUNC-013 through multiple control structures.
//
// Params:
...
// SwitchManyWithDefault has a switch with many cases causing high complexity. Complexity = 12 (1 base + 10 cases + 1 if). This intentionally violates KTN-FUNC-013.
//
// Params:
...
// SelectManyWithDefault has a select with many communication cases causing high complexity. Complexity = 11 (1 base + 5 comm cases + 5 ifs). This intentionally violates KTN-FUNC-013.
//
// Params:
