...
// Test_runTest006_disabled tests that the rule is skipped when disabled.
func Test_runTest006_disabled(t *testing.T) {
	tests := []struct {
		name string
	}{
		{"validation"},
...
// Test_runTest006_excludedFile tests that excluded files are skipped.
func Test_runTest006_excludedFile(t *testing.T) {
	tests := []struct {
		name string
	}{
		{"validation"},
