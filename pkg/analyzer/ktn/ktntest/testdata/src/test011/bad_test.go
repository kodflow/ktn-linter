...
func TestParseConfig(t *testing.T) { // want "KTN-TEST-007: le test 'TestParseConfig' teste une fonction qui retourne error, il devrait couvrir les cas d'erreur"
...
func TestValidateInput(t *testing.T) { // want "KTN-TEST-007: le test 'TestValidateInput' teste une fonction qui retourne error, il devrait couvrir les cas d'erreur"
	// Test uniquement le cas valide
