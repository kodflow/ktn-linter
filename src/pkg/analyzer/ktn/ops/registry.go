...
var AllRules []*analysis.Analyzer = []*analysis.Analyzer{RuleChan001, RuleComp001, RuleConv001, RuleAssert001, RuleOp001, RulePointer001, RulePredecl001, RuleReturn001}
