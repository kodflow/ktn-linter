...
// Retourne "UNKNOWN" si aucun code n'est trouvé
...
// Retourne le message sans le code d'erreur et sans les lignes suivantes
...
// Retourne une chaîne vide si aucun exemple n'est trouvé
...
// Cherche entre quotes simples (ex: "Constante 'MaxValue' sans type")
// Retourne "MyConst" par défaut si aucun nom n'est trouvé
...
// Cherche des types Go connus dans la suggestion
// Retourne "int" par défaut si aucun type n'est trouvé
